--KRAJ
insert into Kraj (IdKraju, NazwaKraju) values (1, 'Niemcy');
insert into Kraj (IdKraju, NazwaKraju) values (2, 'Japonia');
insert into Kraj (IdKraju, NazwaKraju) values (3, 'Francja');
insert into Kraj (IdKraju, NazwaKraju) values (4, 'Wielka Brytania');
insert into Kraj (IdKraju, NazwaKraju) values (5, 'USA');

--Producenci Samochodow
insert into Producent (IdProducenta, IdKraju, NazwaProducenta) values (1, 1, 'Mercedes');
insert into Producent (IdProducenta, IdKraju, NazwaProducenta) values (2, 1, 'Audi');
insert into Producent (IdProducenta, IdKraju, NazwaProducenta) values (3, 1, 'BMW');
insert into Producent (IdProducenta, IdKraju, NazwaProducenta) values (4, 2, 'Mazda');
insert into Producent (IdProducenta, IdKraju, NazwaProducenta) values (5, 2, 'Honda');
insert into Producent (IdProducenta, IdKraju, NazwaProducenta) values (6, 2, 'Mitsubishi');
insert into Producent (IdProducenta, IdKraju, NazwaProducenta) values (7, 3, 'Citroen');
insert into Producent (IdProducenta, IdKraju, NazwaProducenta) values (8, 3, 'Peugeot');
insert into Producent (IdProducenta, IdKraju, NazwaProducenta) values (9, 3, 'Renault');
insert into Producent (IdProducenta, IdKraju, NazwaProducenta) values (10, 4, 'Aston Martin');
insert into Producent (IdProducenta, IdKraju, NazwaProducenta) values (11, 4, 'Bentley');
insert into Producent (IdProducenta, IdKraju, NazwaProducenta) values (12, 4, 'Jaguar');
insert into Producent (IdProducenta, IdKraju, NazwaProducenta) values (13, 5, 'Ford');
insert into Producent (IdProducenta, IdKraju, NazwaProducenta) values (14, 5, 'Chevrolet');
...
--SAMOCHODY
INSERT into Samochód (IdSalonu,IdSamochodu,IdProducenta,Model,Kolor,RokProdukcji,TypSilnika,MocSilnika,CenaSamochodu)
VALUES
